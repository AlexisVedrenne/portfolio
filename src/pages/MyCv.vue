    ...
    <q-card class="q-mb-lg" id="pdf">
      ...
      <q-card-section class="row">
        <div class="col q-ml-lg">
          ...
          <q-separator class="bg-dark" style="height: 8px" spaced />
          <h5 class="text-bold q-ma-none q-mb-sm q-mt-md">FORMATIONS</h5>
          <q-list class="bg-grey-2" v-for="(formation, index) in formations" :key="index">
            <q-item>
          ...
          <q-list class="bg-grey-2" v-for="(parcour, index) in parcours" :key="index">
            <q-item>
              <q-item-section style="font-size: 17px">
                <q-item-label
                  ><strong>{{ parcour.poste }},</strong> {{ parcour.ligne }}</q-item-label
                >
                <q-item-label lines="2"
